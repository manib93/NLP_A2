...
def _parse_args():
    ...
    parser.add_argument('--lr', type=float, default=0.11, help='learning rate')
...
def quadratic_grad(x1, x2):
    ...
    """
    partial_diff_x1 = 2*(x1-1)
    partial_diff_x2 = 16*(x2-1)
    partial_diffs = np.array([partial_diff_x1, partial_diff_x2])
